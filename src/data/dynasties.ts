...
export const allDynasties = [
  ...
  { id: 'in_modern', name: '现代因纽特社会', countryId: 'inuit-civilization', startYear: 1900, endYear: 2020, color: '#B0BEC5', summary: '努纳武特区建立与现代自治' },
  // 莫切/纳斯卡文明
  ...
  { id: 'sa_modern', name: '沙特阿拉伯王国', countryId: 'saudi-arabia', startYear: 1932, endYear: 2020, color: '#00AA00', summary: '阿卜杜勒-阿齐兹建国至今的现代王国' },
  // 土耳其共和国
  { id: 'tk_war_independence', name: '独立战争', countryId: 'turkey', startYear: 1919, endYear: 1923, color: '#E03C31', summary: '凯末尔领导抵抗希腊入侵' },
  { id: 'tk_republic', name: '土耳其共和国', countryId: 'turkey', startYear: 1923, endYear: 2020, color: '#DC143C', summary: '凯末尔改革后的现代化进程' },
  // 伊拉克
  ...
  { id: 'iq_modern', name: '现代伊拉克', countryId: 'iraq', startYear: 1920, endYear: 2020, color: '#DEB887', summary: '从委任统治到共和国' },
  // 以色列
  ...
  { id: 'is_modern', name: '以色列国', countryId: 'israel', startYear: 1948, endYear: 2020, color: '#0066CC', summary: '独立建国至今' },
  // 巴基斯坦
  ...
  { id: 'pk_modern', name: '巴基斯坦伊斯兰共和国', countryId: 'pakistan', startYear: 1947, endYear: 2020, color: '#00AA00', summary: '分治后独立建国' },
  // 阿富汗
  ...
  { id: 'af_modern', name: '现代阿富汗', countryId: 'afghanistan', startYear: 1919, endYear: 2020, color: '#4D4D4D', summary: '从独立到塔利班政权' },
  // 缅甸
  ...
  { id: 'mm_modern', name: '现代缅甸', countryId: 'myanmar', startYear: 1948, endYear: 2020, color: '#FFF176', summary: '独立后至今' },
  // 印度尼西亚
  ...
  { id: 'id_modern', name: '印度尼西亚共和国', countryId: 'indonesia', startYear: 1945, endYear: 2020, color: '#EF5350', summary: '独立至今' },
  // 菲律宾
  ...
  { id: 'ph_modern', name: '菲律宾共和国', countryId: 'philippines', startYear: 1946, endYear: 2020, color: '#0064B9', summary: '独立至今' },
  // 比利时
  ...
  { id: 'be_independent', name: '比利时王国', countryId: 'belgium', startYear: 1830, endYear: 2020, color: '#FFCA28', summary: '独立至今' },
  // 瑞士
  ...
  { id: 'ch_federal', name: '瑞士联邦', countryId: 'switzerland', startYear: 1848, endYear: 2020, color: '#EF5350', summary: '现代联邦制中立国' },
  // 奥地利
  ...
  { id: 'at_republic', name: '奥地利共和国', countryId: 'austria', startYear: 1918, endYear: 2020, color: '#EF4444', summary: '从第一共和国到第二共和国' },
  // 波兰
  ...
  { id: 'pl_modern', name: '现代波兰', countryId: 'poland', startYear: 1918, endYear: 2020, color: '#FF6B6B', summary: '复国至今' },
  // 瑞典
  ...
  { id: 'se_modern', name: '现代瑞典', countryId: 'sweden', startYear: 1814, endYear: 2020, color: '#0088CC', summary: '中立政策至今' },
  // 挪威
  ...
  { id: 'no_modern', name: '现代挪威', countryId: 'norway', startYear: 1905, endYear: 2020, color: '#EB4D50', summary: '石油发现后的富裕国家' },
  // 丹麦
  ...
  { id: 'dk_modern', name: '现代丹麦', countryId: 'denmark', startYear: 1849, endYear: 2020, color: '#EE3548', summary: '宪政至今' },
  // 芬兰
  ...
  { id: 'fi_modern', name: '芬兰共和国', countryId: 'finland', startYear: 1917, endYear: 2020, color: '#0060CD', summary: '独立至今' },
  // 捷克
  ...
  { id: 'cz_czech', name: '捷克共和国', countryId: 'czech-republic', startYear: 1993, endYear: 2020, color: '#3882DE', summary: '独立至今' },
  // 匈牙利
  ...
  { id: 'hu_modern', name: '现代匈牙利', countryId: 'hungary', startYear: 1918, endYear: 2020, color: '#EC6B7B', summary: '独立至今' },
  // 罗马尼亚
  ...
  { id: 'ro_modern', name: '现代罗马尼亚', countryId: 'romania', startYear: 1989, endYear: 2020, color: '#0062E3', summary: '革命后至今' },
  // 乌克兰
  ...
  { id: 'ua_modern', name: '乌克兰', countryId: 'ukraine', startYear: 1991, endYear: 2020, color: '#0093FA', summary: '独立至今' },
  // 阿尔及利亚
  ...
  { id: 'dz_modern', name: '阿尔及利亚民主人民共和国', countryId: 'algeria', startYear: 1962, endYear: 2020, color: '#00AB51', summary: '独立至今' },
  // 突尼斯
  ...
  { id: 'tn_modern', name: '突尼斯共和国', countryId: 'tunisia', startYear: 1956, endYear: 2020, color: '#FA5656', summary: '独立至今' },
  // 利比亚
  ...
  { id: 'ly_modern', name: '利比亚', countryId: 'libya', startYear: 1951, endYear: 2020, color: '#4D4D4D', summary: '独立至今' },
  // 苏丹
  ...
  { id: 'sd_modern', name: '苏丹共和国', countryId: 'sudan', startYear: 1956, endYear: 2020, color: '#BBBBBB', summary: '独立至今' },
  // 肯尼亚
  ...
  { id: 'ke_modern', name: '肯尼亚共和国', countryId: 'kenya', startYear: 1963, endYear: 2020, color: '#4D4D4D', summary: '独立至今' },
  // 尼日利亚
  ...
  { id: 'ng_modern', name: '尼日利亚联邦共和国', countryId: 'nigeria', startYear: 1960, endYear: 2020, color: '#00CE90', summary: '独立至今' },
  // 加纳（现代）
  ...
  { id: 'gh_modern', name: '加纳共和国', countryId: 'ghana-modern', startYear: 1957, endYear: 2020, color: '#006B3F', summary: '撒哈拉以南非洲第一个独立国家' },
  // 古巴
  ...
  { id: 'cu_revolution', name: '革命后', countryId: 'cuba', startYear: 1959, endYear: 2020, color: '#004DBF', summary: '卡斯特罗革命至今' },
  // 危地马拉
  ...
  { id: 'gt_modern', name: '危地马拉共和国', countryId: 'guatemala', startYear: 1821, endYear: 2020, color: '#87BDE2', summary: '独立至今' },
  // 海地
  ...
  { id: 'ht_revolution', name: '海地革命后', countryId: 'haiti', startYear: 1804, endYear: 2020, color: '#003BD0', summary: '世界第一个黑人共和国' },
  // 多米尼加
  ...
  { id: 'do_modern', name: '多米尼加共和国', countryId: 'dominican-republic', startYear: 1844, endYear: 2020, color: '#E03C4C', summary: '独立至今' },
  // 智利
  ...
  { id: 'cl_modern', name: '智利共和国', countryId: 'chile', startYear: 1818, endYear: 2020, color: '#ED4D4D', summary: '独立至今' },
  // 秘鲁
  ...
  { id: 'pe_modern', name: '秘鲁共和国', countryId: 'peru', startYear: 1824, endYear: 2020, color: '#EF4A50', summary: '独立至今' },
  // 哥伦比亚
  ...
  { id: 'co_modern', name: '哥伦比亚共和国', countryId: 'colombia', startYear: 1819, endYear: 2020, color: '#FDE926', summary: '独立至今' },
  // 委内瑞拉
  ...
  { id: 've_modern', name: '委内瑞拉玻利瓦尔共和国', countryId: 'venezuela', startYear: 1811, endYear: 2020, color: '#EF3646', summary: '独立至今' },
  // 厄瓜多尔
  ...
  { id: 'ec_modern', name: '厄瓜多尔共和国', countryId: 'ecuador', startYear: 1822, endYear: 2020, color: '#FFEA66', summary: '独立至今' },
  // 玻利维亚
  ...
  { id: 'bo_modern', name: '多民族玻利维亚国', countryId: 'bolivia', startYear: 1825, endYear: 2020, color: '#ED4D4D', summary: '以玻利瓦尔命名' },
  // 巴布亚新几内亚
  ...
  { id: 'pg_modern', name: '巴布亚新几内亚', countryId: 'papua-new-guinea', startYear: 1975, endYear: 2020, color: '#4D4D4D', summary: '独立至今' },
  // 斐济
  ...
  { id: 'fj_modern', name: '斐济共和国', countryId: 'fiji', startYear: 1970, endYear: 2020, color: '#00BB7A', summary: '独立至今' },
  // 萨摩亚
  ...
  { id: 'ws_modern', name: '萨摩亚独立国', countryId: 'samoa', startYear: 1962, endYear: 2020, color: '#E2304E', summary: '太平洋岛国中第一个独立' },
  // 汤加
  ...
  { id: 'to_modern', name: '汤加王国', countryId: 'tonga', startYear: 1970, endYear: 2020, color: '#EE4050', summary: '唯一保留君主制的太平洋岛国' },
]
